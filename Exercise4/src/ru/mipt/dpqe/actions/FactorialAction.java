...
//      List<? extends Integer> numbers = new ArrayList<>();                            // Integer is final!
    ...
    private void populateNumbersWithSecrets(List<Integer> numbers, String[] secrets) {
        for (String secret : secrets) {
            int i = Integer.parseInt(secret);
            numbers.add(i);
        }
    }
